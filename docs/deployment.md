...
为了使 PR 自动生成并评论 Vercel Preview URL，还需要配置：

- `VERCEL_TOKEN`: Vercel Account Settings -> Tokens 中创建的部署 Token。
- `VERCEL_ORG_ID`: Vercel 团队或个人账号 ID。
- `VERCEL_PROJECT_ID`: 当前 Vercel 项目 ID。
