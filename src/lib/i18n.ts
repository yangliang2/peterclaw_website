...
export const ui = {
  zh: {
    ...
    searchTitle: '全文搜索',
    searchDescription: '搜索博客与知识库文章，可按内容类型筛选。',
    searchPlaceholder: '输入关键词…',
    searchFiltersLabel: '按内容类型筛选',
  ...
  en: {
    ...
    searchDescription: 'Search blog posts and knowledge base articles, then filter by content type.',
    searchPlaceholder: 'Search keywords…',
    searchFiltersLabel: 'Filter by content type',
