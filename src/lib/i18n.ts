...
export const ui = {
  zh: {
    ...
    notFoundCode: '404',
    notFoundTitle: '这页走丢了',
    notFoundDescription: '链接可能已失效，或地址打错了。别急着离开——试试搜索，或看看下面几篇热门内容。',
    notFoundHome: '返回首页',
    notFoundSearchHeading: '搜索站点内容',
    ctaTitle: '喜欢这篇内容吗？',
  ...
  en: {
    ...
    notFoundDescription: 'The link may be outdated, or the URL might have a typo. Stick around—search the site or try a few popular reads below.',
    notFoundHome: 'Back to home',
    notFoundSearchHeading: 'Search the site',
