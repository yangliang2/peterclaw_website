...
Score cards below cover 8 core dimensions (weighted total + radar). See the article body for learning curve and open-source notes.

<div class="review-score-grid">

<ReviewScoreCard
  title="Antigravity 2.0"
  tableLabels={{ dimension: 'Dimension', max: 'Max', score: 'Score', weight: 'Weight' }}
  dimensions={[
    { name: 'Multi-Agent Parallelism', score: 5, weight: 0.125, note: 'Native 5-way parallelism' },
    { name: 'Spec / Plan-Driven', score: 3.5, weight: 0.125 },
    { name: 'Model Freedom', score: 3, weight: 0.125, note: 'Mainly tied to Gemini' },
    { name: 'Code Generation Quality', score: 5, weight: 0.125, note: 'Gemini 3.5 Flash speed + quality' },
    { name: 'Ecosystem Integration', score: 4.5, weight: 0.125, note: 'Strong on Google stack' },
    { name: 'Response Speed', score: 5, weight: 0.125, note: '~289 tokens/s' },
    { name: 'Price Friendliness', score: 3.5, weight: 0.125 },
    { name: 'China Accessibility', score: 3.5, weight: 0.125 },
  ]}
/>
...
<ReviewScoreCard
  ...
  tableLabels={{ dimension: 'Dimension', max: 'Max', score: 'Score', weight: 'Weight' }}
  dimensions={[
    { name: 'Multi-Agent Parallelism', score: 3.5, weight: 0.125 },
    { name: 'Spec / Plan-Driven', score: 5, weight: 0.125, note: 'Most complete spec workflow' },
    { name: 'Model Freedom', score: 4.5, weight: 0.125 },
    { name: 'Code Generation Quality', score: 4.5, weight: 0.125 },
    { name: 'Ecosystem Integration', score: 5, weight: 0.125, note: 'AWS integration unmatched' },
    { name: 'Response Speed', score: 4.5, weight: 0.125 },
    { name: 'Price Friendliness', score: 3.5, weight: 0.125 },
    { name: 'China Accessibility', score: 4.5, weight: 0.125, note: 'AWS access acceptable' },
  ]}
/>
...
<ReviewScoreCard
  ...
  tableLabels={{ dimension: 'Dimension', max: 'Max', score: 'Score', weight: 'Weight' }}
  dimensions={[
    { name: 'Multi-Agent Parallelism', score: 4.5, weight: 0.125, note: 'Supported but needs config' },
    { name: 'Spec / Plan-Driven', score: 4.5, weight: 0.125, note: 'Flexible Plan mode' },
    { name: 'Model Freedom', score: 5, weight: 0.125, note: 'Supports any model' },
    { name: 'Code Generation Quality', score: 4.5, weight: 0.125 },
    { name: 'Ecosystem Integration', score: 4.5, weight: 0.125 },
    { name: 'Response Speed', score: 4.5, weight: 0.125 },
    { name: 'Price Friendliness', score: 5, weight: 0.125, note: 'Free BYOK' },
    { name: 'China Accessibility', score: 5, weight: 0.125, note: 'Best with domestic APIs' },
  ]}
/>
