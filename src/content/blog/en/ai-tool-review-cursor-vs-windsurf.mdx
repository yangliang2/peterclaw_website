...
<ReviewScoreCard
  ...
  dimensions={[
    { name: 'Code Completion', score: 5, weight: 0.2, note: "Cursor Tab's predictive ability is clearly ahead" },
    { name: 'Agent Tasks', score: 5, weight: 0.2, note: 'Composer is more precise' },
    { name: 'Context Understanding', score: 5, weight: 0.15, note: 'at-mention system is more mature' },
    { name: 'Response Speed', score: 4.5, weight: 0.15 },
    { name: 'Price', score: 4.5, weight: 0.15 },
    { name: 'Learning Curve', score: 5, weight: 0.05, note: 'Zero-friction for VS Code users' },
    { name: 'Chinese Support', score: 5, weight: 0.1, note: 'More stable in Chinese' },
  ]}
/>
...
<ReviewScoreCard
  ...
  tableLabels={{ dimension: 'Dimension', max: 'Max', score: 'Score', weight: 'Weight' }}
  dimensions={[
    { name: 'Code Completion', score: 4.5, weight: 0.2 },
    { name: 'Agent Tasks', score: 4.5, weight: 0.2, note: 'Cascade has stronger terminal integration' },
    { name: 'Context Understanding', score: 4.5, weight: 0.15 },
    { name: 'Response Speed', score: 5, weight: 0.15, note: 'Faster indexing and lower completion latency' },
    { name: 'Price', score: 5, weight: 0.15, note: 'Pro is $5/month cheaper with a more generous free tier' },
    { name: 'Learning Curve', score: 5, weight: 0.05, note: 'Zero-friction for VS Code users' },
    { name: 'Chinese Support', score: 4.5, weight: 0.1 },
  ]}
/>
