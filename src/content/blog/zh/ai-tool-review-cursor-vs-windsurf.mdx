...
<ReviewScoreCard
  title="Cursor"
  dimensions={[
    { name: '代码补全', score: 5, weight: 0.2, note: 'Cursor Tab 的预测能力明显领先' },
    { name: 'Agent 任务', score: 5, weight: 0.2, note: 'Composer 更精细' },
    { name: '上下文理解', score: 5, weight: 0.15, note: 'at-mention 符号系统更成熟' },
    { name: '响应速度', score: 4.5, weight: 0.15 },
    { name: '价格', score: 4.5, weight: 0.15 },
    { name: '上手门槛', score: 5, weight: 0.05, note: 'VS Code 用户零门槛' },
    { name: '中文支持', score: 5, weight: 0.1, note: '中文稳定性更好' },
  ]}
/>
...
<ReviewScoreCard
  title="Windsurf"
  dimensions={[
    { name: '代码补全', score: 4.5, weight: 0.2 },
    { name: 'Agent 任务', score: 4.5, weight: 0.2, note: 'Cascade 终端集成更强' },
    { name: '上下文理解', score: 4.5, weight: 0.15 },
    { name: '响应速度', score: 5, weight: 0.15, note: '索引更快，日常补全延迟更低' },
    { name: '价格', score: 5, weight: 0.15, note: 'Pro 便宜 $5/月，免费版更慷慨' },
    { name: '上手门槛', score: 5, weight: 0.05, note: 'VS Code 用户零门槛' },
    { name: '中文支持', score: 4.5, weight: 0.1 },
  ]}
/>
