...
<ReviewScoreCard
  title="Claude Code"
  dimensions={[
    { name: '上下文理解', score: 5, weight: 0.125, note: '200K 上下文优势明显' },
    { name: '命令行 UX', score: 5, weight: 0.125, note: 'Agent 交互更自然' },
    { name: '代码补全（TS）', score: 5, weight: 0.125 },
    { name: '代码补全（Python）', score: 5, weight: 0.125, note: '复杂类型推断更准' },
    { name: '价格', score: 4.5, weight: 0.125, note: '按量计费' },
    { name: '国内可访问性', score: 3.5, weight: 0.125 },
    { name: '隐私与合规', score: 4.5, weight: 0.125, note: '不上传代码训练模型' },
    { name: 'GitHub 生态集成', score: 3.5, weight: 0.125 },
  ]}
/>
...
<ReviewScoreCard
  ...
  dimensions={[
    { name: '上下文理解', score: 4.5, weight: 0.125 },
    { name: '命令行 UX', score: 4.5, weight: 0.125 },
    { name: '代码补全（TS）', score: 5, weight: 0.125, note: '两者均接近满分' },
    { name: '代码补全（Python）', score: 4.5, weight: 0.125 },
    { name: '价格', score: 5, weight: 0.125, note: '$10/月固定' },
    { name: '国内可访问性', score: 4.5, weight: 0.125, note: 'API 连通性更好' },
    { name: '隐私与合规', score: 4.5, weight: 0.125, note: '不上传代码训练模型' },
    { name: 'GitHub 生态集成', score: 5, weight: 0.125, note: '原生支持 Issues/PR/Actions' },
  ]}
/>
