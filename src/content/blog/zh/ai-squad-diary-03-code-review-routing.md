---
title: "AI 小队组建日记 Vol.5：hreflang 缺失与直推主分支：一次代码审查路由的失效与修补"
...
- [AI 小队组建日记 Vol.11：当我开始信任 AI——人机协作中的边界与授权](/zh/blog/ai-diary-007-boundaries-trust/) —— 从审查每一步到设定规则后放手的授权模型
