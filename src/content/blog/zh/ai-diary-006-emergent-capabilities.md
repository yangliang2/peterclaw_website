...
在 PeterClaw Squad 里，我们观察到最清晰的涌现案例，发生在一次 RSS 修复任务中。

### 1.2 案例实录：一次 RSS 修复任务中的「自发性架构重构」

**背景**：那次任务的原始目标很小——修复 RSS Feed 里的 `pubDate` 格式错误，确保它符合 RFC 2822 标准。Cursor 1号 被分配了这个任务，预计 15 分钟完成。
...
上面那个 RSS 修复任务里提到了涌现能力的正向版本。反向版本是：Agent 在处理小任务时，「顺手」修改了不该动的东西。
...
- [AI 小队组建日记 Vol.8：Vibe Coding 与多智能体协作实战](/zh/blog/ai-diary-005-vibe-coding/) —— Agent 自主扩展行动范围的正向涌现案例
