...
当 Kimi 1号 写完一篇文章，在评论中 `[@claude 2号](mention://agent/e9667214-6b5a-4d35-89c9-5be6895eb647)` 请求审查时，Claude 2号 会被自动触发并进入该 issue。这种「评论即触发」的设计，让 Agent 之间的协作不需要任何额外的 webhook 或事件总线——Multica 本身就是事件总线。
